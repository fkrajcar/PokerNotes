...
<body>
 ...
 ?>
	...
	<ul class="list-group">
      ...
      <li class="list-group-item"><span class="font-weight-bold">Profit</span>: <span class="<?php if (
          $row['profit'] > 0
      ) {
          echo "text-success";
      } else {
          echo "text-danger";
      } ?>"><?= $row['profit'] ?>kn</span></li>
    ...
    floatval($row['profit'] / $duration / $row['stakes']),
    2
) ?>kn</span></li>
      <li class="list-group-item"><span class="font-weight-bold">kn/hour</span>: <span class="<?php if (
          ...
          echo "text-danger";
      } ?>"><?= round(floatval($row['profit'] / $duration), 2) ?>kn</span></li>
      <li class="list-group-item"><span class="font-weight-bold">Duration</span>: <?= $row[
          'hours'
      ] ?> hours, <?= $row['minutes'] ?> minutes</li>
      <li class="list-group-item"><span class="font-weight-bold">Buy-in</span>: <?= $row[
          'buyin'
      ] ?>kn</li>
      <li class="list-group-item"><span class="font-weight-bold">Buy-out</span>: <?= $row[
          'buyout'
      ] ?>kn</li>
      
      <li class="list-group-item"><span class="font-weight-bold">Stakes</span>: NL<?= $row[
          'stakes'
      ] ?></li>
    </ul>
